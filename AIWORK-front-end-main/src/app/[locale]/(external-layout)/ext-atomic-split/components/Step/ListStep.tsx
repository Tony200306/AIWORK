...
import { useCreateExtStep } from "@/hooks/shared/useCreateExtStep";
import { useUpdateExtStep } from "@/hooks/shared/useUpdateExtStep";
import { useUpdateExtSteps } from "@/hooks/shared/useUpdateExtSteps";
...
export default function ListStep({
  ...
  const { mutateAsync: createStep, isPending: isCreating } = useCreateExtStep({
    setIsAdding,
    brainDumpId: params.id as string,
  });
  const { mutateAsync: updateStep, isPending: isUpdatingStep } = useUpdateExtStep({
    setIsEditing,
    brainDumpId: params.id as string,
  });
  ...
  console.log("Items state:", items, steps);
