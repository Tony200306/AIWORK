...
function StackLoginContent() {
  ...
  // Show loading while OAuth login is processing
  if (authStore.data.isOAuthLoggingIn) {
    return (
      <div className="flex min-h-screen items-center justify-center">
        <div className="text-center space-y-4">
          <Loading />
          <p className="text-muted-foreground">Logging in with OAuth...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="w-full max-w-sm space-y-8">
          <div className="space-y-2">
            <h1 className="text-3xl font-bold tracking-tight">
              Welcome to Vantum AI
            </h1>
            <p className="text-sm text-muted-foreground">
              Sign in to transform your tasks into manageable steps
            </p>
          </div>
          ...
          <div className="text-center space-y-6 max-w-2xl">
            ...
            <div className="pt-6">
              <p className="text-xl text-gray-300 max-w-lg mx-auto leading-relaxed">
                Let Vantum AI help you prioritize what matters and break down complex tasks into manageable steps.
              </p>
            </div>
          </div>
        </div>
